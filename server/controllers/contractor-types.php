<?php
    ...
    function add_contractor_type ($postdata) {
        ...
        if (!$statement = oci_parse($connection, "begin pkg_contractor_types.p_insert_contractor_type(:title, :new_contractor_type); end;")) {
            $error = oci_error();
            echo $error["message"];
        } else {
            ...
            if (!oci_bind_by_name($statement, ":new_contractor_type", $cursor, -1, OCI_B_CURSOR)) {
                $error = oci_error();
                echo $error["message"];
            }
    ...
    function edit_contractor_type ($postdata) {
        ...
        if (!$statement = oci_parse($connection, "begin pkg_contractor_types.p_edit_contractor_type(:ct_id, :title, :contractor_type); end;")) {
            $error = oci_error();
            echo $error["message"];
        } else {
            if (!oci_bind_by_name($statement, ":title", $data -> title, -1, OCI_DEFAULT)) {
            ...
            if (!oci_bind_by_name($statement, ":contractor_type", $cursor, -1, OCI_B_CURSOR)) {
                $error = oci_error();
                echo $error["message"];
            }
            if (!oci_execute($statement)) {
    ...
    function delete_contractor_type ($postdata) {
        ...
        if (!$statement = oci_parse($connection, "begin pkg_contractor_types.p_delete_contractor_type(:ct_id, :moment); end;")) {
            $error = oci_error();
            echo $error["message"];
        } else {
            if (!oci_bind_by_name($statement, ":ct_id", $data -> id, -1, OCI_DEFAULT)) {
    ...
    function get_contractor_types () {
        ...
        if (!$statement = oci_parse($connection, "begin pkg_contractor_types.p_get_contractor_types(:data); end;")) {
            $error = oci_error();
            echo $error["message"];
        } else {
